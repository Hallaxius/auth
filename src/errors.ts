...
export class PasswordTooShortError extends AuthError {
	constructor(message = "Password is too short", options?: { cause?: Error }) {
		super(ErrorCodes.PASSWORD_TOO_SHORT, message, {
			statusCode: 400,
			cause: options?.cause,
		});
	}
...
export class PasswordTooLongError extends AuthError {
	constructor(message = "Password is too long", options?: { cause?: Error }) {
		super(ErrorCodes.PASSWORD_TOO_LONG, message, {
			statusCode: 400,
			cause: options?.cause,
		});
	}
...
export class PasswordInvalidFormatError extends AuthError {
	constructor(
		message = "Password format is invalid",
		options?: { cause?: Error },
	) {
		super(ErrorCodes.PASSWORD_INVALID_FORMAT, message, {
			statusCode: 400,
			cause: options?.cause,
		});
	}
